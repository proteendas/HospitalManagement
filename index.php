      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/hms_1.jpg"  alt="slider"  data-bgposition=" center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:gray; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Best Hospitality Services in Kolkata</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/hms_2.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/hms_3.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 6; font-size:40px; color:#000; font-weight:500; white-space: nowrap;"> Welcome To Our World class Facilty </div>
          ...
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                ...
                <p>Besides providing world class clinical lab services, Diagnostic Centre houses a pool of doctors of different medical specialty to serve the ailing patients as outpatients. They are all reputed and respected in their medical specialty for outstanding clinical management</p>
                <ul class="row">
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis consequuntur maiores rem minus ipsum iste.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur doloribus animi modi neque sunt officia.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam, expedita neque laborum quaerat reprehenderit itaque.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed corporis voluptates autem fugit reiciendis ducimus.</p>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="p-t-b-150">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h2>Our Services</h2>
          <hr>
          <span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta tenetur tempora, dolorem consectetur laborum tempore!</span> </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus, possimus!</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis, ullam?</p>
                </div>
              </article>
            </div>
